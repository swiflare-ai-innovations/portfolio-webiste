        ...
        <section ref={sectionRef} id="contact" className="relative min-h-screen bg-editorial-silk py-28 overflow-hidden flex flex-col justify-between">
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
                ...
                <div className="contact-reveal mb-32 space-y-4" style={{ opacity: 0, visibility: 'hidden' }}>
                    ...
                    <h2 className="font-serif text-7xl md:text-9xl text-editorial-text tracking-tighter leading-[0.85]">
                        Surgical Mastery <br />
                        <span className="italic text-editorial-accent ml-[5%]">Human Care</span>
                    </h2>
                </div>
                ...
                <div className="contact-grid grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mb-32">
                    ...
                    <div className="contact-reveal lg:col-span-7 bg-editorial-text text-editorial-silk p-12 md:p-20 relative overflow-hidden group shadow-2xl" style={{ opacity: 0, visibility: 'hidden' }}>
                        <div className="relative z-10 space-y-16">
                            <div className="space-y-4">
                                ...
                                <h3 className="font-serif text-4xl md:text-5xl italic">Secure your <br />consultation</h3>
                            </div>
                        ...
                        <div className="absolute top-0 right-0 p-8 opacity-10 text-[60px] font-serif italic pointer-events-none select-none">K.</div>
                    </div>
                    ...
                    <div className="lg:col-span-5 space-y-12 lg:pt-20">
                        <div className="contact-reveal relative p-12 border border-editorial-border/40 bg-white/60 backdrop-blur-xl group overflow-hidden rounded-3xl shadow-sm" style={{ opacity: 0, visibility: 'hidden' }}>
                            ...
                            <div className="space-y-8 relative z-10">
                                <div className="space-y-4">
                                    ...
                                    <h4 className="font-serif text-3xl italic leading-tight">Adyar, Chennai</h4>
                                </div>
                                ...
                                <div className="pt-8 flex items-center gap-4">
                                    ...
                                    <p className="text-[9px] font-bold tracking-[0.2em] uppercase opacity-40 italic">Coordinates Verified</p>
                                </div>
                            </div>
                        ...
                        <div className="contact-reveal px-12 italic text-editorial-subtext/60 font-serif text-lg leading-relaxed" style={{ opacity: 0, visibility: 'hidden' }}>
            ...
            <div className="relative z-10 w-full border-t border-editorial-border/30 bg-editorial-silk py-12 px-6 backdrop-blur-md">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
                    ...
                    <ul className="flex flex-wrap justify-center gap-x-12 gap-y-4">
                        {['Home', 'About', 'Timeline', 'Expertise', 'Contact'].map((link) => (
                            <li key={link}>
                                <a href={`#${link.toLowerCase()}`} className="text-[9px] font-bold tracking-[0.3em] uppercase text-editorial-text hover:opacity-100 opacity-60 transition-all duration-500">
                                    {link}
                                </a>
                            </li>
                        ))}
